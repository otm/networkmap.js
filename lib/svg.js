...
;(function() {
  ...
  SVG.ViewBox = function(element) {
    ...
    this.x      = box.x
    this.y      = box.y
    this.width  = element.node.clientWidth  || (('' + element.attr('width')).indexOf('%') === -1) ? element.attr('width') : null || element.node.getBoundingClientRect().width
    this.height = element.node.clientHeight || (('' + element.attr('height')).indexOf('%') === -1) ? element.attr('height') : null || element.node.getBoundingClientRect().height
